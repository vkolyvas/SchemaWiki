...
class FeatureFileUpdate(BaseModel):
    ...
    filename: str = Field(..., pattern=r"^(plan\.md|implementation\.md|agent_steps\.yaml|architecture\.md|api_contracts\.yaml|tests\.md)$")
    content: str
...
class HookEvent(BaseModel):
    ...
    event_type: str = Field(..., pattern=r"^(feature_created|feature_updated|feature_deleted|build_started|build_failed|test_failed|deploy)$")
